...
export async function Header() {
  ...
  return (
    <header id="header" className="absolute top-0 left-0 right-0 border-b border-solid border-b-white/10 backdrop-blur-sm">
